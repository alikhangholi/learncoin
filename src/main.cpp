...
uint256 hashGenesisBlock("0xcec34d5c66d58e5088b6295c299a1db6d5bd2324f17181e1233793a7747cd395");
...
static const int64 nTargetTimespan = 10 * 30; // Learncoi  n: 5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xcec34d5c66d58e5088b6295c299a1db6d5bd2324f17181e1233793a7747cd395");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1561534080;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1726748;
